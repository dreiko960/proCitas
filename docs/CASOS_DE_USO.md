...
| **PasarelaPago** | Actor externo **simulado**: procesa pagos con tarjeta en línea (sin integración real Izipay/Niubiz/VisaNet). |
...
| UC-52 | Check-in presencial y asignar turno | Recepcionista | Cita `pagada` | Cita `en_espera_triaje` con turno `A-00X` |
